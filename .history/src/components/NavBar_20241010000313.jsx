...
const pages = ['Inicio', 'Productos', 'Acerca de nosotros', 'Contáctanos'];
        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', mr: 3.5 }}>
          ...
          mt: '45px',
            ...
            '& .MuiMenuItem-root': {
                ...
                '&:hover': {
                    backgroundColor: 'rgba(192, 192, 192, 0.10)', // Fondo al pasar el mouse
                },
            },
        }}
            ...
            >
              {settings.map((setting) => (
                <MenuItem key={setting} onClick={handleCloseUserMenu}>
                  <Box sx={{ backgroundColor: 'rgb(192, 192, 192)', padding: '8px', borderRadius: '4px', width: '100%' }}></Box>
