...
import { db } from "../../../firebaseConfig"; // Asegúrate de que la configuración de Firebase es correcta
...
const ItemDetail = ({ addToCart }) => {
  ...
  useEffect(() => {
    ...
    const fetchItemDetails = async () => {
      try {
        console.log(`Buscando producto con ID: ${id}`); // Log de depuración
        ...
        if (docSnapshot.exists()) {
          ...
          console.log('Producto encontrado:', productData); // Log de depuración
        ...
        <Grid item xs={12} sm={6} sx={{ textAlign: 'center' }}>
          ...
          <CardMedia
            ...
            sx={{
              objectFit: 'contain',
              height: 'auto',
              maxHeight: '400px', // Ajusta el tamaño según tus necesidades
              borderRadius: '8px',
            }}
          />
