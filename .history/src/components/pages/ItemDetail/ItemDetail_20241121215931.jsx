    ...
    <Box sx={{ padding: 2 }}>
      <Box
        sx={{
          ...
          boxShadow: 4,
          marginTop: 3,
          flexWrap: "wrap", // Hace que se ajusten los elementos en pantallas pequeñas
        }}
      >
        ...
        <Box
          sx={{
            ...
            alignItems: "center",
            maxWidth: "100%",
            marginBottom: { xs: 3, md: 0 }, // Ajusta el margen en pantallas pequeñas
          }}
        >
          <CardMedia
            component="img"
        ...
        <Box
          sx={{
            ...
            padding: "20px",
            height: "100%",
            maxWidth: { xs: "100%", sm: "80%" }, // Ajusta el ancho para pantallas pequeñas
          }}
        >
          <Box
            sx={{
