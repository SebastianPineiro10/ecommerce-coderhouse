...
export const ItemListContainer = () => {
  ...
  const uploadProductsToFirestore = async () => {
    ...
    // Filtrar los productos nuevos (isUploaded: false) de products.js
    const newProducts = products.filter(product => !product.isUploaded);

    // Recorrer los productos nuevos de products.js
    for (const product of newProducts) {
      ...
      // Después de subir el producto, marcarlo como subido
