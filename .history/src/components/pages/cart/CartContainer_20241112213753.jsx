              ...
              >
                ...
                <Box sx={{ display: "flex", alignItems: "center" }}>
                  ...
                  <TextField
                    ...
                    onChange={(e) => handleQuantityChange(product.cartItemId, e)}  {/* Usar cartItemId aquí */}
                  ...
                  <IconButton color="error" onClick={() => handleRemoveFromCart(product.cartItemId)}>  {/* Usar cartItemId aquí */}
                    <DeleteIcon />
                  </IconButton>
                </Box>
              </Box>
