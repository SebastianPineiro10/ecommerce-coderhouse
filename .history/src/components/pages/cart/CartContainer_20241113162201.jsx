...
const CartContainer = () => {
  ...
  return (
    <Box sx={{ padding: 3 }}>
      ...
      {cart.length > 0 && (
        <Box sx={{ marginTop: 2 }}>
          <Button variant="contained" color="primary" sx={{ width: "100%", padding: "12px", fontSize: "16px" }} onClick={handleGoToBrief}>
            Ver Resumen
          </Button>
          <Button variant="contained" color="secondary" sx={{ width: "100%", padding: "12px", fontSize: "16px", marginTop: 2 }} onClick={handleCheckout}>
            Finalizar compra
          </Button>
        </Box>
      )}
