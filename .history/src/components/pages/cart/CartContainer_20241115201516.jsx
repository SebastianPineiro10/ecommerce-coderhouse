...
const CartContainer = () => {
  // Verifica que useCart esté devolviendo el contexto correctamente
  const { cart, removeFromCart, updateQuantity, getTotal, getTotalQuantity, startCheckout } = useCart();
  const navigate = useNavigate();

  if (!cart) {
    // Asegúrate de que cart no sea undefined o null
    return <div>Loading...</div>; // Puedes devolver un estado de carga si no se ha cargado el carrito
  }
