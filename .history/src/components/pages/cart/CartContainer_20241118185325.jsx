...
const CartContainer = () => {
  ...
  return (
    <Box sx={{ padding: 3, backgroundColor: "rgba(255, 255, 255, 0.7)", borderRadius: "10px", boxShadow: 3 }}>
        ...
        <Grid container spacing={2}>
          {cart.map((product) => (
            <Grid item xs={12} md={6} key={product.cartItemId}>
              <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", border: "1px solid #ddd", padding: 2, borderRadius: 2, boxShadow: 1, backgroundColor: "#fff" }}>
