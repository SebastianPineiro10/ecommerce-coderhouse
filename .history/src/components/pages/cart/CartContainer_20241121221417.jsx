            ...
            <Grid item xs={12} key={product.cartItemId}>
              <Box
                sx={{
                  ...
                  "&:hover": {
                    boxShadow: "0px 20px 30px rgba(0, 0, 0, 0.2)", // Sombra más profunda al hacer hover
                    transform: "scale(1.05)", // Un poco más de efecto de escala
                  },
                }}
              >
                ...
                <Box sx={{ display: "flex", flexDirection: "column", alignItems: "flex-end" }}>
                  ...
                  <Box
                    sx={{
                      ...
                      padding: "10px 16px", // Más padding para mayor comodidad
                    }}
                  >
                    <IconButton
