    ...
    >
      ...
      {cart.length === 0 ? (
        ...
        <Grid container spacing={4} sx={{ flex: 1 }}>
          {cart.map((product) => (
            <Grid item xs={12} sm={6} md={4} key={product.cartItemId}> {/* Responsive en Grid */}
              <Box
                sx={{
                  display: "flex",
                  flexDirection: "row",
        ...
        <Box sx={{ marginTop: 4 }}>
          ...
          <Box
            sx={{
              display: "flex",
              justifyContent: "space-between",
              flexDirection: { xs: "column", sm: "row" }, // Ajuste para pantallas pequeñas y grandes
              gap: 2,
            }}
          >
            <Button
              ...
              sx={{
                padding: "12px",
                fontSize: "16px",
                width: { xs: "100%", sm: "45%" }, // Los botones ocuparán todo el ancho en pantallas pequeñas
