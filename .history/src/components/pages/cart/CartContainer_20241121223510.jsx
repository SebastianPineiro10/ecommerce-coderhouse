                ...
                <Box sx={{ display: "flex", alignItems: "center", width: "50%" }}>
                  ...
                  <Typography
                    ...
                    sx={{
                      ...
                      fontFamily: "'Poppins', sans-serif",
                      overflow: "hidden",
                      textOverflow: "ellipsis",  // Aseguramos que el texto largo no se desborde
                      whiteSpace: "nowrap",  // Evitamos que el texto se rompa en varias líneas
                      maxWidth: "150px", // Limitar el tamaño máximo para no desbordarse
                    }}
                  >
                    {product.title}
                  </Typography>
