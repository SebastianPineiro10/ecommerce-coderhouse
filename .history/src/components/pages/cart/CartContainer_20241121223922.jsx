              ...
              <Box sx={{ display: "flex", flexDirection: "row", alignItems: "center", width: "60%" }}>
                ...
                <Typography
                  ...
                  sx={{
                    ...
                    fontSize: "16px",
                    fontFamily: "'Poppins', sans-serif",
                    maxWidth: "150px", // Asegura que el texto se ajuste dentro del cuadro
                    wordBreak: "break-word", // Permite que el texto se ajuste a varias líneas si es necesario
                    overflow: "hidden", // Evita el desbordamiento
                    textOverflow: "ellipsis", // Si el texto es muy largo, lo corta
                  }}
                >
                  {product.title}
                </Typography>
