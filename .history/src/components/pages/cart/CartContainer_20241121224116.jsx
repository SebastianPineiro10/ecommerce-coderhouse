              ...
              <Box sx={{ display: "flex", flexDirection: "row", alignItems: "center", width: "60%" }}>
                ...
                <Typography
                  ...
                  sx={{
                    ...
                    fontSize: "16px",
                    fontFamily: "'Poppins', sans-serif",
                    maxWidth: "200px", // Aseguramos que el título no se estire demasiado
                    wordBreak: "break-word", // Permite que el texto se ajuste en varias líneas si es necesario
                    overflow: "hidden", // Evita el desbordamiento
                    textOverflow: "ellipsis", // Si el título es muy largo, se corta con "..."
                    lineHeight: "1.4", // Ayuda a controlar la altura del texto si se ajusta
                  }}
                >
                  {product.title}
                </Typography>
