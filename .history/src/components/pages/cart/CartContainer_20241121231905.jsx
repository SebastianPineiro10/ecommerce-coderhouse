          ...
          >
            ...
            <Button
              ...
              sx={{
                ...
                "&:hover": {
                  backgroundColor: "#003366", // Sin cambio de color al hacer hover
                  boxShadow: "none", // Sin sombra en el hover
                },
                // Fondo interior blanco
                "& .MuiButton-label": {
                  backgroundColor: "#fff", // Fondo blanco interior
                  color: "#003366", // Texto de color azul marino
                },
              }}
            ...
            <Button
              ...
              sx={{
                ...
                boxShadow: "none", // Sin sombra
                "&:hover": {
                  backgroundColor: "#9b4dca", // Sin cambio de color al hacer hover
                  boxShadow: "none", // Sin sombra en el hover
                },
                // Fondo interior blanco
                "& .MuiButton-label": {
                  backgroundColor: "#fff", // Fondo blanco interior
                  color: "#9b4dca", // Texto de color morado
                },
              }}
