import { Box, Typography, Button, Grid, Divider, IconButton, TextField } from "@mui/material"; // Imports necesarios
import { useCart } from "../../../context/CartContext"; // Accedemos al contexto del carrito
