...
const CartContainer = () => {
  ...
  const handleRemoveFromCart = (productId, boxSize) => {
    removeFromCart(productId, boxSize); 
  };

  // Manejo de la actualización de cantidades
  const handleQuantityChange = (productId, boxSize, e) => {
    const newQuantity = parseInt(e.target.value, 10);
    if (!isNaN(newQuantity) && newQuantity >= 1) {
      updateQuantity(productId, boxSize, newQuantity); 
    }
  };
              ...
              >
                ...
                <Box sx={{ display: "flex", alignItems: "center" }}>
                  ...
                  <TextField
                    ...
                    onChange={(e) => handleQuantityChange(product.id, product.boxSize, e)}
                  ...
                  <IconButton color="error" onClick={() => handleRemoveFromCart(product.id, product.boxSize)}>
                    <DeleteIcon />
                  </IconButton>
                </Box>
              </Box>
