...
export const CartProvider = ({ children }) => {
  ...
  const addToCart = (product) => {
    setCart((prevCart) => {
      ...
      if (productIndex >= 0) {
        // Si el producto ya está en el carrito, actualizar la cantidad y el precio total de ese producto
      ...
      // Si el producto no está en el carrito, agregarlo como un nuevo elemento independiente
