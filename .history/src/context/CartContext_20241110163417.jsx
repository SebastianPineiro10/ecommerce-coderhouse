    ...
    setCart((prevCart) => {
      ...
      if (existingProduct) {
        ...
        const updatedCart = prevCart.map((item) =>
          item.id === product.id && item.boxSize === product.boxSize
        ...
        // Si el producto no está en el carrito, lo agregamos con una cantidad inicial de 1 si no tiene cantidad definida
