...
// Este codigo si separa los productos pero no los sumas correcto y no me deja borrarlos del carrito
...
export const CartProvider = ({ children }) => {
  ...
  const getTotal = () => {
    return cart.reduce((total, item) => total + (item.price * item.quantity || 1), 1);
  };
