    ...
    if (isInCart) {
      ...
      const updatedCart = cart.map((item) => {
        if (item.id === product.id) {
          ...
          return {
            ...item,
            quantity: item.quantity + product.quantity, // Aumentar la cantidad
          };
        }
        return item;
      });
      ...
      const newCartItem = { 
        ...product, 
        cartItemId: generateCartItemId(), // ID único para cada item
        quantity: product.quantity, // La cantidad que pasamos
      };
