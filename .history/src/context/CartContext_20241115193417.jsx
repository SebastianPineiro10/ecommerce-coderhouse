...
export const CartProvider = ({ children }) => {
  const [cart, setCart] = useState([]);  // Estado que guarda el carrito de compras
  ...
  const addToCart = (product) => {
    ...
    if (isInCart) {
      ...
      const newCartItem = {
        ...
        quantity: 1,  // La cantidad siempre comienza en 1 cuando se agrega por primera vez
      };
      setCart((prevCart) => [...prevCart, newCartItem]);  // Añadimos el nuevo producto al carrito
