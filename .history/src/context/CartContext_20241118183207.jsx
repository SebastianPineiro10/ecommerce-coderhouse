...
export const CartProvider = ({ children }) => {
  ...
  const addToCart = (product) => {
    // Buscar si el producto ya está en el carrito usando el id único del producto (id de Firebase)
    ...
    if (existingItem) {
      ...
      if (product.stock > 0) {
        const newCartItem = { ...product, quantity: 1 }; // Agregamos el producto con cantidad 1
